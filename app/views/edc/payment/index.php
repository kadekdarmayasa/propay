            ...
            <table>
              ...
              for ($i = 0; $i < count($data['payment']); $i++) : ?>
                <tr>
                  ...
                  <?php else : ?>
                    <td>Rp. <?= number_format($data['student']['bills']['nominal'], 0, ',', '.'); ?></td>
                  <?php endif; ?>
                  ...
                  <?php if ($data['payment'][$i]['payment_amount'] == null) : ?>
                    <td>
                      <?php
                      $dash = '';
                      $nominalArr = str_split($data['student']['bills']['nominal']);
                  ...
                  <?php if ($data['payment'][$i]['payment_status'] == 'Unpaid' || $data['payment'][$i]['payment_status'] == 'Paif Half') : ?>
                    <td>
