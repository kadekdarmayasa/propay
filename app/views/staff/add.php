    ...
    <form action="" method="post">
      ...
      <div class="form second">
        <div class="input-group">
          ...
          <select name="level-user" id="level-user" required>
        ...
        <div class="input-group">
          ...
          <input type="text" name="staff-name" id="staff-name" placeholder="Enter staff name..." required>
        </div>

        <div class="input-group">
          <label for="date-of-birth">Date of Birth</label>
          <input type="date" name="date-of-birth" id="date-of-birth" placeholder="Enter birth date..." required>
        ...
        <div class="input-group">
          ...
          <select name="religion" id="religion" required>
            <option value="">-- Select Regliion --</option>
