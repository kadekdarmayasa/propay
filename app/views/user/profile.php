        ...
        <form action="" method="post">
          ...
          <div class="form">
            ...
            <div class="input-group prev-submit-btn">
              ...
              <button type="submit" name="save-staff-profile" class="submit-btn">
          ...
          <small class="forgot-password-link">
            Forgot your password? <a href="<?= BASEURL . 'user/reset_password/' . $_SESSION['user']['staff_id'] ?>">Reset Here</a>
          </small>
        </form>
      </div>
    <?php else : ?>
      <div class="first-content">
        <div class="meta">
          <h2 class="meta-title">Student Profile</h2>
        </div>
        ...
        <form action="" method="post">
          <input type="hidden" class="input sin" name="sin" id="sin" value="<?= $data['student']['sin'] ?>">

          <div class="form">
            <div class="input-group">
              <label for="student-name">Name</label>
              <input type="text" name="student-name" class="input" id="student-name" placeholder="Enter student name..." autocomplete="off" value="<?= $data['student']['student_name'] ?>" required autofocus="off">
            </div>

            <div class="input-group">
              <label for="date-of-birth">Date of Birth</label>
              <input type="date" class="input" name="date-of-birth" id="date-of-birth" placeholder="Enter birth date..." value="<?= $data['student']['date_of_birth'] ?>" required autofocus="off">
              <svg width="27" height="27" viewBox="0 0 27 27" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect x="2" y="4" width="23" height="20" rx="2" stroke="white" stroke-width="2" />
                <rect x="6" y="14" width="5" height="5" rx="1" stroke="white" stroke-width="2" />
                <rect x="16" y="14" width="5" height="5" rx="1" stroke="white" stroke-width="2" />
            ...
            <div class="input-group">
              <label for="address">Address</label>
              <textarea name="address" class="input textarea" id="address" cols="30" rows="3" autocomplete="off" placeholder="Enter full address..." required autofocus="off"><?= $data['student']['address'] ?></textarea>
            </div>
            ...
            <div class="input-group prev-submit-btn">
              ...
              <button type="submit" name="save-student-profile" class="submit-btn">
                <span>Save Profile</span>
                <svg width="23" height="28" viewBox="0 0 23 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M1 6V25.5945C1 26.4842 2.07459 26.9309 2.70529 26.3034L10.6439 18.4053C11.0298 18.0214 11.6518 18.0166 12.0435 18.3945L20.3057 26.3654C20.9407 26.978 22 26.528 22 25.6457V6C22 3.23858 19.7614 1 17 1H6C3.23858 1 1 3.23858 1 6Z" stroke="black" stroke-width="2" />
                </svg>
          ...
          <small class="forgot-password-link">
            Forgot your password? <a href="<?= BASEURL . 'user/reset_password/' . $_SESSION['user']['sin'] ?>">Reset Here</a>
          </small>
        </form>
      </div>
    <?php endif; ?>
