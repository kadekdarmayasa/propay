...
overlayDeleteBtn.addEventListener('click', async function (e) {
	...
	try {
		...
		if (response.status === 'success') {
			...
			overlayMetaDescription.innerHTML = `Student with sin ${response.sin} has been successfully deleted`;
		...
		overlayMetaDescription.innerHTML = `Student cannot be deleted`;
